...
var sourceW = 320;
var sourceH = 568;
var windowW = document.documentElement.clientWidth;//浏览器宽
var windowH = document.documentElement.clientHeight;//浏览器高
var background=document.getElementById("background");
var oLis = document.querySelectorAll("#list>li");

var winW=getComputedStyle(background,null).width;//图片框宽
var winH=getComputedStyle(background,null).height;//图片框高
var fontScale=320/100;
var fontSize=windowW/fontScale;
...
function move(ev) {
    ...
    this.style.webkitTransform = "scale(" + (1 - Math.abs(changeY / winH) * step ) + ") translate(0,0)";
