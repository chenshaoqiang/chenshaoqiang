        ...
        try {
            ...
            function orientationHandler(event) {
                ...
                if(currentGamma==0){
                    ...
                    if(Math.round(event.gamma)>currentGamma&&(Math.round(event.gamma)-currentGamma>=5)){
                        //设备逆时针扭转：右偏
                        e.previousOne();
                        currentGamma=Math.round(event.gamma);
                    }else if(Math.round(event.gamma)<currentGamma&&(Math.round(event.gamma)-currentGamma<=(-5))){
                        //设备顺时针扭转：左偏
                        e.nextOne();
                        currentGamma=Math.round(event.gamma);
                    }else{
                ...
                /*text += "左右旋转： " + Math.round(event.alpha) + "度<p>";
                text += "前后旋转： " + Math.round(event.beta) + "度<p>";*/
                text += "扭转设备： " + Math.round(event.gamma) + "度<p>";
