...
<div class="wrap" id="wrap">
    ...
    <div class="modalImg" id="modalImg">
        <img id="targetImg" src="${imgpath}" style="height: 50%;">
    </div>
</div>
</body>
<script type="application/javascript" charset="utf-8">
    ...
    var bigPic = $(".scroll-img-td img"), isPlay = true, isTurn = true, isShowMagBox = false, startX = 0, startY = 0, mStartX = 0, mStartY = 0,
            distance = {},imgScale = 1,origin, mLeft, speed = 30, scrollImgBox = document.getElementById("scrollImgBox"),imgPageX,imgPageY,
            modalImg = document.getElementById("modalImg"),imgLeft = 0,imgTop,
            magnifierBox = document.getElementById("magnifier_box"), circleProgressWrapper = document.getElementById("circleProgress_wrapper"),
            scrollImg = document.getElementById("scroll-img"), imgHeight, imgBoxH, imgBoxW, lineProgressW = 0,
    ...
    function getImgSize() {
        ...
        $("#main_img_work").each(function (i) {
            ...
            $("<img/>").attr("src", $(bigPic).attr("src")).load(function () {
                ...
                $("#magnifierImg1").css({
                    "background": "url(" + $(bigPic).attr("src") + ") no-repeat",
                    "background-size": "100%"
                });//放大镜内的背景图
